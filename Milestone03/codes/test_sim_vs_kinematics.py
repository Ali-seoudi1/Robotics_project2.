...
# Load kinematics module from current directory
script_dir = os.path.dirname(os.path.abspath(__file__))
kin_path = os.path.join(script_dir, 'kinematics_derivations.py')
kin = SourceFileLoader('kin', kin_path).load_module()

# Model path - try multiple locations
project_root = os.path.abspath(os.path.join(script_dir, '..', '..'))
model_path = os.path.join(project_root, 'install', 'mujoco_ros2', 'share', 'mujoco_ros2', 'model', 'ur5e.xml')
